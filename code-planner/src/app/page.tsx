                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-3">
                    {results.results.map((r) => (
                      <div key={r.model} className="card">
                        <div className="card-header">
                          <h3 className="card-title">{r.model}</h3>
                        </div>
                        <div className="p-5">
                          <pre className="whitespace-pre-wrap text-sm text-neutral-800">{r.output}</pre>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <p className="card-subtitle">Generated by OpenAI ({settings.selectedModels.openai || "gpt-5.2-chat-latest"})</p>
                    </div>
                    <div className="p-5">
